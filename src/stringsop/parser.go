...
func NewStringsOp(sopts []string, options []Option) *StringsOp {
	return &StringsOp{options, sopts, 0, "="}
}

func (sop *StringsOp) Next() (string, string, error) {
